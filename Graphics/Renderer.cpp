...
namespace graphics{
    ...
    void Renderer::recreateSwapChain() {
        ...
        if(swapChain == nullptr){
            ...
            swapChain = std::make_unique<graphics::SwapChain>(device, extent,oldSwapChain);
    ...
    void Renderer::beginSwapChainRenderPass(VkCommandBuffer commandBuffer) {
        assert(isFrameStarted && "Can't call beingSwapChainRenderPass while frame not in progress");
